...
export function nocksetup() {
  ...
  api
    .post('/v1/user/spot/order', { pair: 'btc_jpy', amount: 0.001, price: 500000, side: 'buy', type: 'limit', post_only: true  })
    .reply(200, testdata.sendOrderRes);
  api.post('/v1/user/spot/order', { pair: 'btc_jpy', amount: 0.001, price: 500000, side: 'buy', type: 'limit', post_only: true  }).reply(200, testdata.sendOrderError);
